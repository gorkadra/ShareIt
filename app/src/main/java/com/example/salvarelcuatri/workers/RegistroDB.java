...
public class RegistroDB extends Worker {
    ...
    public Result doWork() {
        String direccion = "http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/gdelrio004/WEB/Shareit/Registro.php?";
        ...
        String parametros = "nombre=" + usuario + "&contra=" + contra + "&mail=" + correo;
        try {
